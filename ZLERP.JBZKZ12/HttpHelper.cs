...
namespace ZLERP.JBZKZ12
{
    ...
    public class HttpHelper
    {
        ...
        public string Post(object entity, string requestUri)
        {
            ...
            HttpContent httpContent = new StringContent(request, Encoding.UTF8);
            MediaTypeHeaderValue mh = new MediaTypeHeaderValue("application/json");
            mh.CharSet = "UTF-8";
            httpContent.Headers.ContentType = mh;
