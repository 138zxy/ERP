...
namespace ZLERP.Model
{
	...
	public class SysFunc : _SysFunc, ITreeGridable
    {
        ...
        public static DefaultSysFuncComparer DefaultComparer = new DefaultSysFuncComparer();


        public class DefaultSysFuncComparer : IEqualityComparer<SysFunc>
        {
            public bool Equals(SysFunc x, SysFunc y)
            {
                return string.Equals(x.ID, y.ID, StringComparison.OrdinalIgnoreCase);
            }

            public int GetHashCode(SysFunc obj)
            {
