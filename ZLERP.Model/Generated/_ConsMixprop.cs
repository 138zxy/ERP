...
namespace ZLERP.Model.Generated
{
    ...
    public abstract class _ConsMixprop : EntityBase<string>
    {
        ...
        /// 材料二十四湿料用量
        /// </summary>
        [DisplayName("材料二十五湿料用量")]
        public virtual decimal? S25_wet
        {
            get;
            set;
        }
        ...
        /// 材料二十四湿料用量
        /// </summary>
        [DisplayName("材料二十六湿料用量")]
        public virtual decimal? S26_wet
        {
            get;
            set;
        }
        ...
        /// 材料二十四湿料用量
        /// </summary>
        [DisplayName("材料二十七湿料用量")]
        public virtual decimal? S27_wet
        {
            get;
            set;
        }
        ...
        /// 材料二十四湿料用量
        /// </summary>
        [DisplayName("材料二十八湿料用量")]
        public virtual decimal? S28_wet
        {
            get;
            set;
        }
        ...
        /// 材料二十四湿料用量
        /// </summary>
        [DisplayName("材料二十九湿料用量")]
        public virtual decimal? S29_wet
        {
            get;
            set;
        }
        ...
        /// 材料二十四湿料用量
        /// </summary>
        [DisplayName("材料三十湿料用量")]
        public virtual decimal? S30_wet
        {
            get;
            set;
        }
        ...
        /// 材料二十四湿料用量
        /// </summary>
        [DisplayName("材料三十一湿料用量")]
        public virtual decimal? S31_wet
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// 外加剂比率： 外加剂比率 等于 外加剂用量除以水泥和掺和料的总量， 触发器计算
        /// </summary>
        [DisplayName("外加剂比率")]
        public virtual decimal? ADMRate
        {
            get;
            set;
        }
