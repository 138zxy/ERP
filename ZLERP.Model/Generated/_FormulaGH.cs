...
namespace ZLERP.Model.Generated
{
    ...
    /// </summary>
    public abstract class _FormulaGH : EntityBase<string>
    {
        #region Methods
        ...
        public override int GetHashCode()
        {
			...
			sb.Append(FormulaGHName);
			sb.Append(FormulaGHType);
        ...
        [StringLength(50)]
        [Required]
        public virtual string FormulaGHName
        {
            get;
			set;			 
        }	
        ...
        [DisplayName("料种")]
        [StringLength(20)]
        public virtual string FormulaGHType
        {
            get;
			set;			 
        }	
        ...
        [ScriptIgnore]
		public virtual IList<FormulaGHItem> FormulaGHItems
        {
            get;
            set;
        }
