...
namespace ZLERP.Model.Generated
{
    ...
    public abstract class _Car : EntityBase<string>
    {
        ...
        /// </summary>
        [DisplayName("运输单位")] 
        public virtual int?  RentCarName
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DisplayName("运费类型")]
        public virtual string FreightType
        {
            get;
            set;
        }
        ...
        [DisplayName("车辆颜色")]
        [StringLength(50)]
        public virtual string CarColour
        {
            get;
            set;
        }
        ...
        [DisplayName("外廓尺寸")]
        [StringLength(50)]
        public virtual string OverDimension
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DisplayName("保养间隔里程")]
        public virtual decimal MaintainCycle
        {
            get;
            set;
        }
        ...
        [ScriptIgnore]
        public virtual B_CarFleet B_CarFleet
        {
            get;
            set;
        }
