...
namespace ZLERP.Model.Generated
{
    ...
    /// </summary>
    public abstract class _ShippingDocument : EntityBase<string>
    {
        #region Methods
        ...
        public override int GetHashCode()
        {
            ...
            sb.Append(Auditor2);
            sb.Append(ProOverTimeCount);
            sb.Append(ProBuCube);
            sb.Append(ProBuPrice);
            sb.Append(ProOverTimePrice);
            sb.Append(ProOverTimeMoney);
			sb.Append(Version);
        ...
        [Required]
        [DisplayName("调度混凝土方量")]
        public virtual decimal SendBetonCount
        {
            get;
            set;
        }
        ...
        [Required]
        [DisplayName("调度砂浆方量")]
        public virtual decimal SendSlurryCount
        {
            get;
            set;
        }	
        ...
        [DisplayName("泵车司机")]
        [StringLength(30)]
        public virtual string PumpDriver
        {
            get;
            set;
        }	
        ...
        [ScriptIgnore]
		public virtual IList<TZRalation> TZRalations
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DisplayName("超时补助")]
        public virtual decimal OverTimeSubsidy
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DisplayName("车队超时时长")]
        public virtual decimal OverTimeCount
        {
            get;
            set;
        }
        ...
        [DisplayName("运输费用")]
        public virtual decimal TranMoney
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DisplayName("工地超时时长")]
        public virtual decimal ProOverTimeCount
        {
            get;
            set;
        }
        ...
        [DisplayName("工地补方方量")]
        public virtual decimal ProBuCube
        {
            get;
            set;
        }
        [DisplayName("工地补方单价")]
        public virtual decimal ProBuPrice
        {
            get;
            set;
        }
        [DisplayName("工地超时单价")]
        public virtual decimal ProOverTimePrice
        {
            get;
            set;
        }
        [DisplayName("工地超时费用")]
        public virtual decimal ProOverTimeMoney
        {
            get;
            set;
        }
