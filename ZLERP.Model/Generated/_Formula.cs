...
namespace ZLERP.Model.Generated
{
    ...
    public abstract class _Formula : EntityBase<string>
    {
        ...
        [DisplayName("容重最小值")]
        public virtual decimal? MinLimitWeight
        {
            get;
            set;
        }
        [DisplayName("容重最大值")]
        public virtual decimal? MaxLimitWeight
        {
            get;
            set;
        }
        [DisplayName("水泥矿粉最小值")]
        public virtual decimal? MinSKLimitWeight
        {
            get;
            set;
        }
        [DisplayName("水泥矿粉最大值")]
        public virtual decimal? MaxSKLimitWeight
        {
            get;
            set;
        }
