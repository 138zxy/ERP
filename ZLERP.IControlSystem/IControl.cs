...
namespace ZLERP.IControlSystem
{
    public interface IControl
    {
        ...
        /// <param name="cm"></param>
        /// <returns></returns>
        bool GenConsMixpropGH(ConsMixpropGH cm, IList<ConsMixpropItemGH> cmItemsList);
        /// <summary>
        /// 修改配比
        /// </summary>
        /// <param name="cm"></param>
        /// <param name="cmItemsList"></param>
        /// <returns></returns>
        ResultInfo UpdateConsMixpropGH(ConsMixpropGH cm, IList<ConsMixpropItemGH> cmItemsList);
    }
}
