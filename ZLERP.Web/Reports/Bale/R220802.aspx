...
<script runat="server" language="c#">
    ...
    protected void ReportViewer1_Drillthrough(object sender, DrillthroughEventArgs e)
    {
        ...
        if (subDataSource.SelectParameters.Count > 0)
        {
            subDataSource.SelectParameters.Remove(subDataSource.SelectParameters["BeginDate"]);
            subDataSource.SelectParameters.Remove(subDataSource.SelectParameters["EndDate"]);
        ...
        subDataSource.SelectParameters.Add("BeginDate", rpt.GetParameters()["BeginDate"].Values.FirstOrDefault());
        subDataSource.SelectParameters.Add("EndDate", rpt.GetParameters()["EndDate"].Values.FirstOrDefault());
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Bale\R220802.rdlc" DisplayName="原料进货汇总表">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_rpt_stuffInReport"
       ...
       <asp:SqlDataSource ID="subDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ...
        <SelectParameters>
         <%--   <asp:ControlParameter ControlID="tbBeginDate" Name="BeginDate" PropertyName="Text" />
            ...
            <asp:ControlParameter ControlID="tbStuffID" Name="StuffID" PropertyName="Text" />--%>
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
