<%@ Page Title="生产日期方量统计报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    客户名称：<asp:TextBox ID="txtCustName" Width="120" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Produce\R410723.rdlc" DisplayName="生产日期方量统计报表">
            <DataSources>
