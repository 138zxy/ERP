<%@ Page Title="生产台账" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    施工部位:<asp:TextBox ID="txtConsPos" Width="100" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Produce\R4107414.rdlc"  DisplayName="生产台账">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_produce_stats_detail05"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="txtConsPos" Name="consPos" PropertyName="Text" /> 
            </SelectParameters>
        </asp:SqlDataSource> 
</asp:Content>
