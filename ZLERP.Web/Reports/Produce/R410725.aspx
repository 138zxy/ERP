<%@ Page Title="泵名称方量统计报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            lblCondition.Text = "IsEffective = 1 AND ShipDocType = '0' AND PumpName IS NOT NULL ";
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    泵车：<asp:TextBox ID="tbPumpName" Width="100" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Produce\R410725.rdlc" DisplayName="泵名称方量统计报表">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ...
        <SelectParameters>       
            ...
            <asp:ControlParameter ControlID="tbPumpName" Name="PumpName" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
