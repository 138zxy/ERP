...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
   ...
   起始时间：<asp:TextBox ID="tbBeginDate" Width="135" runat="server"></asp:TextBox>
    ...
    工程名称：<asp:TextBox ID="txtProjectName" runat="server" Width="135"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="100%" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Produce\R410805.rdlc"  DisplayName="砼产品供应量统计">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_ConStrengthStatisticsw"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
