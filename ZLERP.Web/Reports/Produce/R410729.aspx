...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            lblCondition.Text = "IsEffective = 1 AND ShipDocType = '0' AND ProductLineName IS NOT NULL ";
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Produce\R410729.rdlc" DisplayName="生产线方量统计报表">
            <DataSources>
