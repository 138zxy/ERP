<%@ Page Title="应付账款明细表" Language="C#"   MasterPageFile="~/Reports/ReportsBase.Master"
...
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        ...
        document.getElementById("ctl00_Body_ReportViewer1").style.height = "1200px";
        //$('#<%=ReportViewer1.ClientID %>').datepicker();
    }); 
</script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
   ...
   报表日期：<asp:TextBox ID="tbDate" Text=""  runat="server"></asp:TextBox>  
   ...
   <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Produce\R410804.rdlc"  DisplayName="应付账款明细表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_Stuffinfo_pay"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
