...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    收货单位：<asp:TextBox ID="tbCustName" Width="120" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="600px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\ProduceGH\R950710.rdlc"  DisplayName="送货单统计报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server"   
           ...
           SelectCommand="sp_rpt_ShipRecordAllGH"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters>  
