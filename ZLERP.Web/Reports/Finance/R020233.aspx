<%@ Page Title="运费结算表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request["uid"] != null)
        {
            this.tbCarID.Text = Request["uid"].ToString();
        }
        if (!Page.IsPostBack)
        {
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Finance\R020233.rdlc" DisplayName="运费结算表">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_cw_yunfei"
