<%@ Page Title="外加剂检测原始记录(三)报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        <LocalReport ReportPath="Reports\Lab\R720603.rdlc"  DisplayName="外加剂检测原始记录(三)报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_Lab_ADMPressiveStrengt"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
