...
namespace ZLERP.Web.Reports
{
    ...
    public class PrintHelp
    {
        ...
        private void Export(LocalReport report)
        {
            ...
            catch (Exception ex)
            {
                ...
                while (innerEx != null)
                {
                    ...
                    string filename = HttpRuntime.AppDomainAppPath + @"Logs\debugrpt.txt";
                    LogFile(filename, errmessage);
        ...
        public static void LogFile(string fileName, string errContent)
        {
            FileStream file;
            ...
            var bytes = encode.GetBytes(errContent + "---------------------------------------------------------------------------------\r\n");
