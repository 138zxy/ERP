...
function tzrelationInit(opts) {
    ...
    function lockUnFmt(cellvalue, options, cell) {
        ...
        var myJqGridH = new MyGrid({
		    ...
		    , initArray: [
                ...
                , { label: '初始源剩退量', name: 'SourceCube', index: 'SourceCube', width: 150, align: 'center' }
                ...
                , { label: '源量', name: 'operationcube', index: 'operationcube', width: 100 }
                , { label: '目标车号', name: 'CarID', index: 'CarID', width: 100 }
                , { label: '目标量', name: 'Cube', index: 'Cube', width: 100 }
    ...
    var myJqGrid = new MyGrid({
        renderTo: 'MyJqGrid'
		    ...
		    , primaryKey: 'ID'
		    , setGridPageSize: 30
             , storeCondition: '1=1' //(TZValue == null || TZValue == '') ? '1=1' : ("ID='" + TZValue + "'")
            , dialogWidth: 600
            , singleSelect: true
            , dialogHeight: 600
		    , showPageBar: true
		    ...
		    , initArray: [
                ...
                , { label: '源剩退量', name: 'SourceCube', index: 'SourceCube', width: 80, align: 'center' }
                ...
                , { label: '目标剩退量', name: 'Cube', index: 'Cube', width: 80, align: 'center' }
                ...
                , { label: '剩退量', name: 'ActionCube', index: 'ActionCube', width: 80, align: 'center' }
                    ...
                    myJqGrid.handleAdd({
                        ...
                        beforeSubmit: function () {
                            ...
                            if (thisCube > lastCube) {
                                showError('错误', '剩退量不能大于上车运送量，如果整车退回，请使用整车转发功能。');
                                myJqGrid.getFormField('Cube').addClass('input-validation-error');
                                return false;
                            }
                            else
                        ...
                        beforeSubmit: function () {
                            ...
                            if (!isEmpty(carID1)) {
                                ...
                                if (sourceCubeArr[0] <= 0) {
                                    $('#Cube1', '#mergeForm').addClass('input-validation-error');
                                    errorMsg += "<br>剩退量必须大于0。";
                                    checking = false;
                                }

                                if (sourceCubeArr[0] > lastCube1) {
                                    $('#Cube1', '#mergeForm').addClass('input-validation-error');
                                    errorMsg += "<br>剩退量不能大于上车运送量。";
                                    checking = false;
                                }
                            }
                    ...
                    myJqGrid.handleAdd({
                        ...
                        beforeSubmit: function () {
                            ...
                            if (sourceCubeArr[0] + sourceCubeArr[1] + sourceCubeArr[2] + sourceCubeArr[3] + sourceCubeArr[4] > maxcube) {
                                errorMsg += "<br>合并量不能大于车辆容重" + maxcube + "方。";
                                checking = false;
                            }
...
//        alert(i);
    ...
    TargetTaskChange = function () {
        ...
        TargetTaskField.bind('change', function (event) {
            ...
            if (!isEmpty(carid)) {
                var requestURL = '/TZRalationGH.mvc/GetTagCube';
