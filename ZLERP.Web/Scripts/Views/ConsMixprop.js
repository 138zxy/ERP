...
function consMixpropIndexInit(opts) {
    ...
    var options = {
            ...
            , datatype: 'json'
            , mtype: 'POST'
            , postData: { condition: " ProduceTask.IsCompleted=0 and AuditStatus = 1 and ProductLineID = '001'  AND DataType=0  " }
            , jsonReader: {
                root: "rows",
                page: "page",
                total: "total",
    ...
    function getDynamicColAndCreateGrid(pid, plValue) {
        ajaxRequest(
                ...
                function (response) {
                    ...
                    options.postData = { condition: plValue + "AuditStatus = 1 AND DataType=0 " };
