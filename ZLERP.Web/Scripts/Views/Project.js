        ...
        //, { label: ' 是否显示', name: 'IsShow', index: 'IsShow', editable: true, editrules: { required: true} }
            ...
            , functions: {
                ...
                handleRefresh: function (btn) {
                    ProjectGrid.refreshGrid('1=1 and Project.Contract.DataType=0 ');
                },
                ...
                handleAllPro: function (btn) {
                    ProjectGrid.refreshGrid('1=1 ');
                },
                handleHun: function (btn) {
                    ProjectGrid.refreshGrid('1=1 and Contract.DataType=0 ');
                },
                handleSH: function (btn) {
                    ProjectGrid.refreshGrid('1=1 and Contract.DataType=1 ');
                },
