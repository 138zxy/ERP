...
function ProductLineTypeFmt(cellvalue, options, rowObject) {
...
function ProductLineTypeUnFmt(cellvalue, options, cell) {
    ...
    var productLineGrid = new MyGrid({
        ...
        //, width: '100%'
		    ...
		    , initArray: [
                ...
                , { label: '机组类型', name: 'IsGH', index: 'IsGH', align: 'center', width: 50, formatter: ProductLineTypeFmt, unformat: ProductLineTypeUnFmt }
                ...
                , { label: '是否干混砂浆', name: 'IsGH', index: 'IsGH', width: 80, align: 'center', formatter: booleanFmt, unformat: booleanUnFmt }
                ...
                , { label: '公司编号', name: 'CompanyID', index: 'CompanyID', width: 50, align: 'center', hidden: false }
                , { label: '公司名称', name: 'CompName', index: 'CompName', width: 100, editable: false, sortable: false }
                , { label: '备注', name: 'Remark', index: 'Remark' }
   		        , { label: 'NC库存组织', name: 'Org_Stockorg', index: 'Org_Stockorg', stype: 'select', searchoptions: { value: dicToolbarSearchValues('Bd_Stordoc') }, formatter: dicCodeFmt, unformat: dicCodeUnFmt, formatoptions: { parentId: 'Bd_Stordoc' }, width: 80, align: 'center', hidden: true }
		    ]
            , functions: {
