function taskAndFormulaInit(opts) {
    var TaskGrid = new MyGrid({
        renderTo: 'TaskGridDiv'
            ...
            , sortByField: 'IsFormulaSend asc ,ID '
		    , primaryKey: 'ID'
        ...
        , { label: "任务附件", name: "Attachments", formatter: attachmentFmt, sortable: false, search: false }
            ...
            , functions: {
                ...
                handleRefresh: function (btn) {
                    TaskGrid.refreshGrid('1=1 AND IsCompleted=0  AND DataType=0 ');
                },
                ...
                handleTodayTask: function () {
                    ...
                    var condition = "NeedDate between '" + today + " 00:00:00' and '" + today + " 23:59:59' AND DataType=0 ";
                ...
                , handleAllTask: function () {
                    TaskGrid.refreshGrid('1=1 AND DataType=0 ');
                },
                                    ...
                                    if (csValue) {
                                        bindSelectData($("#BetonFormula1"),
                                                ...
                                                { textField: 'FormulaName',
                                                    valueField: 'ID',
                                                    condition: "ConStrength like '%" + csValue + "%' and FormulaType='FType_C' AND DataType=0  and Lifecycle > -1"
                                                }, function () { }
                                                );
                                        bindSelectData($("#SlurryFormula1"),
                                                ...
                                                { textField: 'FormulaName',
                                                    valueField: 'ID',
                                                    condition: "((ConStrength like '%" + csValue + "%' and FormulaType='FType_CS') or FormulaType='FType_S') AND DataType=0 and Lifecycle > -1"
                                                }, function () { }
                                                );
                                    }
                                },
            ...
            afterFormLoaded: function () {
                ...
                if (csValue) {
                    ...
                    if (gSysConfig.IsTaskFormulaMatch && gSysConfig.IsTaskFormulaMatch.toUpperCase() == "TRUE") {
                        ...
                        betonFormulaCondition = "ConStrength like '%" + csValue + "%' and FormulaType='FType_C' AND DataType=0 and Lifecycle > -1 and CastMode ='" + castMode + "'";
                        ...
                        betonFormulaCondition = "ConStrength like '%" + csValue + "%' and FormulaType='FType_C' AND DataType=0 and Lifecycle > -1"
                    }
