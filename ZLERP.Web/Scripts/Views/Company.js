        ...
        renderTo: 'My-JqGrid'　
		    ...
		    , initArray: [
                ...
                , { label: ' 联系人', name: 'LinkMan', index: 'LinkMan', width: 50 }
   		        , { label: 'NC采购组织', name: 'Org_Purchaseorg', index: 'Org_Purchaseorg', stype: 'select', searchoptions: { value: dicToolbarSearchValues('Org_Purchaseorg') }, formatter: dicCodeFmt, unformat: dicCodeUnFmt, formatoptions: { parentId: 'Org_Purchaseorg' }, width: 80, align: 'center', hidden: true }
                ...
                , { label: ' 是否调度显示', name: 'ShowInDispatch', index: 'ShowInDispatch', align: 'center', width: 50, formatter: booleanFmt, unformat: booleanUnFmt }
