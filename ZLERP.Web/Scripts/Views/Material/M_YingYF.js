function M_YingYFIndexInit(options) {
    var myJqGrid = new MyGrid({
		...
		, setGridPageSize: 30
		, showPageBar: true
        , storeCondition: "(supplykind in ('Su1','Su2','Su5') and IsUsed =1)"
		, initArray: [
              { label: '厂商编码', name: 'ID', index: 'ID',  width: 80 }
            , { label: '供货厂商', name: 'SupplyName', index: 'SupplyName', width: 200 }
    ...
    var myJqGridTo = new MyGrid({
        ...
        initArray: [
            ...
            , { label: '付预付额', name: 'FinanceMoney', index: 'FinanceMoney', width: 80, search: false, summaryType: 'sum', summaryTpl: '合计: <font color=red>{0}</font>', align: 'right', formatter: 'currency' }
            , { label: '预付款支出', name: 'YFinanceMoney', index: 'YFinanceMoney', width: 80, search: false, summaryType: 'sum', summaryTpl: '合计: <font color=red>{0}</font>', align: 'right', formatter: 'currency' }
