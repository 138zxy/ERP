function B_PonTranBalanceIndexInit(options) {
    var myJqGrid = new MyGrid({
        renderTo: 'PeCarMyJqGrid'
        , autoWidth: true
        , buttons: buttons0
        , height: 300
		...
		, initArray: [
            ...
            , { label: '泵送单位ID', name: 'TranID', index: 'TranID', width: 60, hidden: true }
            , { label: '泵送单位名称', name: 'B_CarFleet.FleetName', index: 'B_CarFleet.FleetName', width: 150 }
            ...
            , { label: '结算方式', name: 'BaleType', index: 'BaleType', width: 60, hidden: true }
        ...
        , functions: {
            ...
            handleEdit: function (btn) {
                ...
                myJqGrid.handleEdit({
                    loadFrom: 'PeCarTranMyFormDiv',
                    btn: btn,
                    width: 700,
                    height: 500,
                    prefix: "B_PonTranBalance",
            ...
            handleAdd: function (btn) {
                ...
                myJqGridToAdd.refreshGrid("ID NOT IN (SELECT ShipDocID FROM B_TranBalanceDel where ModelType='泵车') AND PumpName in( SELECT ID FROM Car WHERE RentCarName='" + TranID + "' ) and IsAudit=1 and IsEffective=1  and ProjectID='" + ProjectID + "'" + condition);

                $("#PeCarmyJqGridAddDetial").dialog("open");
    ...
    var myJqGridTo = new MyGrid({
        ...
        initArray: [
            ...
            , { label: '泵名称', name: 'ShippingDocument.PumpName', index: 'ShippingDocument.PumpName', width: 150 }
            , { label: '浇筑方式', name: 'ShippingDocument.CastMode', index: 'ShippingDocument.CastMode', width: 100 } 
            , { label: '生产时间', name: 'ShippingDocument.ProduceDate', index: 'ShippingDocument.ProduceDate', formatter: 'datetime', width: 120 }
            , { label: '签收方量', name: 'ShippingDocument.SignInCube', index: 'ShippingDocument.SignInCube', width: 100 }
            , { label: '补方数', name: 'CarBetonNum', index: 'CarBetonNum', editable: true, search: false, width: 80 }
            , { label: '补泵费', name: 'CustBetonfee', index: 'CustBetonfee', editable: true, search: false, width: 80, formatter: 'currency' } 
    ...
    var myJqGridToAdd = new MyGrid({
        renderTo: 'PeCarmyJqGridAddDetial',
        autoWidth: true,
        buttons: buttons2,
        height: 500, 
        ...
        initArray: [
            ...
            , { label: '泵名', name: 'PumpName', index: 'PumpName', width: 150 }
            , { label: '生产时间', name: 'ProduceDate', index: 'ProduceDate', formatter: 'datetime', width: 120 }
            , { label: '浇筑方式', name: 'CastMode', index: 'CastMode', width: 100 }
            , { label: '签收方量', name: 'SignInCube', index: 'SignInCube', width: 100 }
