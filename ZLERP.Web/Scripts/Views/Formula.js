function formulaIndexInit(opts) {
    ...
    var FormulaGrid = new MyGrid({
        renderTo: 'FormulaGridDiv'
            ...
            , storeCondition: filterCondition + ' AND DataType=0 '
		    , sortByField: 'FormulaName'
		    , primaryKey: 'ID'
            , dialogWidth: 730
            , dialogHeight: 650
		    , setGridPageSize: 30
		    ...
		    , initArray: [
                ...
                , { label: ' 级配', name: 'CarpGrade', index: 'CarpGrade', width: 80 }
                ...
                , { label: ' 容重最小值', name: 'MinLimitWeight', index: 'MinLimitWeight', width: 60, align: 'right' }
                , { label: ' 容重最大值', name: 'MaxLimitWeight', index: 'MaxLimitWeight', width: 60, align: 'right' }
                , { label: ' 水泥矿粉最小值', name: 'MinSKLimitWeight', index: 'MinSKLimitWeight', width: 60, align: 'right' }
                , { label: ' 水泥矿粉最大值', name: 'MaxSKLimitWeight', index: 'MaxSKLimitWeight', width: 60, align: 'right' }
...
//                            alert(this);
                ...
                , handleViewHidden: function (btn) {
                    FormulaGrid.refreshGrid("LifeCycle = -1 AND DataType=0 ");
                }
            }
    });
