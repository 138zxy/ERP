    ...
    var shippDocGrid = new MyGrid({
        ...
        //, multiselect: true
		    ...
		    , initArray: [
                ...
                , { label: '生产日期', name: 'ProduceDate', index: 'ProduceDate', width: 130, formatter: 'date', formatoptions: { newformat: "ISO8601Long" }, searchoptions: { dataInit: function (elem) { $(elem).datetimepicker(); }, sopt: ['bd', 'ed', 'eq', 'gt', 'lt']} }
        //, { label: '是否带回', name: 'IsBack', index: 'IsBack', width: 50, align: 'center', formatter: booleanFmt, formatterStyle: { '0': '途中', '1': '已回' }, unformat: booleanUnFmt, stype: 'select', searchoptions: { value: booleanSearchValues()} }
                ...
                , { label: '是否超时', name: 'IsOverTime', index: 'IsOverTime', align: 'center', width: 60, formatter: booleanFmt, unformat: booleanUnFmt, formatterStyle: { '1': '超时', '0': '未超时' }, stype: 'select', searchoptions: { value: booleanIsOverTimeSearchValues() }, editable: false, edittype: 'select', editoptions: { value: booleanIsOverTimeSearchValues() } }
                , { label: '车队超时时长(h)', name: 'OverTimeCount', index: 'OverTimeCount', width: 75, align: 'right', search: false }
                , { label: '工地超时时长(h)', name: 'ProOverTimeCount', index: 'ProOverTimeCount', width: 75, align: 'right', search: false }


                , { label: '销售员', name: 'ProduceTask.Seller', index: 'ProduceTask.Seller', width: 50 }
                ...
                , { label: "车号", name: "CarID", index: "CarID", width: 60, editable: false, formatter: dicCodeFmt, unformat: dicCodeUnFmt, formatoptions: { parentId: "ContractPayType" }, stype: "select", searchoptions: { value: getCarNoStr() }, edittype: 'select', editoptions: { value: getCarNoStr()} }
                ...
                , { label: '调度混凝土方量', name: 'SendBetonCount', index: 'SendBetonCount', width: 90, align: 'right', search: false, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                , { label: '调度砂浆方量', name: 'SendSlurryCount', index: 'SendSlurryCount', width: 80, align: 'right', search: false, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                , { label: '调度总方量', name: 'SendCube', index: 'SendCube', width: 70, align: 'right', editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                , { label: '出票方量', name: 'ParCube', index: 'ParCube', width: 55, align: 'right', search: false, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                ...
                , { label: '运输方量', name: 'ShippingCube', index: 'ShippingCube', width: 55, align: 'right', search: false, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                , { label: '签收方量', name: 'SignInCube', index: 'SignInCube', width: 55, align: 'right', editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                , { label: '报废方量', name: 'ScrapCube', index: 'ScrapCube', width: 55, align: 'right', search: false, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                , { label: '本车余料', name: 'TransferCube', index: 'TransferCube', width: 55, align: 'right', search: false, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                , { label: '其他方量2', name: 'XuCube', index: 'XuCube', width: 60, align: 'right', search: false, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                , { label: '其他方量', name: 'OtherCube', index: 'OtherCube', width: 55, align: 'right', search: false, hidden: true, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                , { label: '生产混凝土方量', name: 'BetonCount', index: 'BetonCount', width: 90, align: 'right', search: false, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2} }
                , { label: '生产砂浆方量', name: 'SlurryCount', index: 'SlurryCount', width: 80, align: 'right', search: false, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2} }
        ...
        // , { label: '运费', name: 'SumPrice', index: 'SumPrice' }
                ...
                , { label: '当班司机', name: 'Driver', index: 'Driver', search: true, editable: false, width: 55, stype: "select", searchoptions: { value: getDriverStr() }, edittype: 'select', editoptions: { value: getDriverStr() } }
                ...
                , { label: '工程运距', name: 'Distance', index: 'Distance', width: 55, editable: false, formatter: "number", formatoptions: { defaulValue: "", decimalPlaces: 2 } }
                ...
                , { label: '公里数', name: 'CarKm', index: 'CarKm', width: 55, editable: false }
                ...
                , { label: "泵名称", name: "PumpName", index: "PumpName", width: 60, editable: false, formatter: dicCodeFmt, unformat: dicCodeUnFmt, formatoptions: { parentId: "ContractPayType" }, stype: "select", searchoptions: { value: getPumpStr() }, edittype: 'select', editoptions: { value: getPumpStr() } }
                , { label: '超时原因', name: 'OverTimeReason', index: 'OverTimeReason', width: 200, search: false, editable: false }
                , { label: '超时补助', name: 'OverTimeSubsidy', index: 'OverTimeSubsidy', width: 80, search: false, editable: false }
                , { label: '小票票号', name: 'TicketNO', index: 'TicketNO', width: 80, editable: false }
            ...
            , functions: {
                ...
                handleRefresh: function (btn) {
                    shippDocGrid.refreshGrid('1=1 AND DataType=0 ');
                },
                    ...
                    shippDocGrid.showWindow({
                        ...
                        buttons: {
                            "确定": function () {
                                ...
                                var IsEffective = shippDocGrid.getSelectedRecord().IsEffective;
                                if (isEmpty(PrintReportID)) {
                                    showMessage("提示", "请选择发货单模板");
                                    return false;
                                }
                                if (IsEffective == 'false') {
                                    showMessage("提示", "只能打印有效运输单");
                                    return false;
                                }
                                console.log(PrintReportID);

                                var url = "/GridReport/PrintDirect.aspx?report=" + PrintReportID + "&ID=" + docId;
                    ...
                    shippDocGrid.showWindow({
                        ...
                        buttons: {
                            "确定": function () {
                                ...
                                var url = "/GridReport/DesignReport.aspx?report=" + PrintReportID;
                                shipdoctype = PrintReportID;
                                window.open(url, "_blank");
                                shippDocGrid.reloadGrid();
                                $(this).dialog("close");
                            }
                ...
                , handleMultiSign: function (btn) {
                    ...
                    for (var i = 0; i < records.length; i++) {
                        ...
                        if (record && record.IsBack == 'true') {
                            showMessage(record.ID + '该运输单已经回厂，不允许再次回厂');
                            return;
                        } 
                    }

                    showConfirm("确认信息", "将选中的运输单进行回厂。是否继续回厂？", function (btn) {
                ...
                , FindTodayRecord: function (btn) {
                    ...
                    condition = "ProduceDate between '" + today + " 00:00:00' and '" + today + " 23:59:59'  AND DataType=0 ";
                    shippDocGrid.refreshGrid(condition);
                }
                , FindTomRecord: function (btn) {
                    var uom = GetDateBySpan(1);
                    condition = "ProduceDate between '" + uom + " 00:00:00' and '" + uom + " 23:59:59'  AND DataType=0 ";
                    shippDocGrid.refreshGrid(condition);
                }
                , FindAllRecord: function (btn) {
                    condition = "1=1  AND DataType=0  ";
                    shippDocGrid.refreshGrid(condition);
                }
                    ...
                    shippDocGrid.showWindow({
                        ...
                        buttons: {
                            "关闭": function () {
                                ...
                                condition = "ProduceDate between '" + BeginTime + "' and '" + EndTime + "' AND DataType=0 ";
                                shippDocGrid.refreshGrid(condition);
