...
function loadCarData() {
    console.log("loadCarData function called");
    console.log(allCars);
    if (allCars == null) {
        window.setTimeout(loadCarData, 5000);
        return;
    }
...
function refreshTask() {
    ...
    //    return;
    console.log("refreshTask function called");
    DoAjax('/ProduceTask.mvc/GetAllUncompletedTasks', null, function (data) {
        $(".pj").empty();
        console.log('/ProduceTask.mvc/GetAllUncompletedTasks');
        console.log(data);
        var html = '';
        $.each(data, function (i, item) {
            ...
            if (i == data.length - 1) {         //加载完全部的任务单后执行
                console.log("allCars == null => " + allCars == null);
