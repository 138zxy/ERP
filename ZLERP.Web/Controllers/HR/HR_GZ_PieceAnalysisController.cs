...
{
    public class HR_GZ_PieceAnalysisController : BaseController<HR_GZ_Piece, string>
    {
        //
        // GET: /SC_Base/
        ...
        public override ActionResult Find(JqGridRequest request, string condition)
        {
            ...
            var GZ_Piece = this.service.GetGenericService<HR_GZ_Piece>().Query().Where(t => t.WorkDate >= begindate && t.WorkDate <= enddate)
            ...
            var GZ_PieceSet = this.service.GetGenericService<HR_GZ_PieceSet>().All();
