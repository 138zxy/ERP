...
{
    public class HR_KQ_ChuChaiController : HRBaseController<HR_KQ_ChuChai, string>
    {
        public override ActionResult Index()
        {

            ViewBag.Leave = GetBaseData(BaseDataType.出差类型);
            return base.Index();
        }

        //public override ActionResult GenerateOrderNo()
        //{
        //    return base.GenerateOrderNo("C");
        //}

 
        public override ActionResult Add(HR_KQ_ChuChai entity)
        {
