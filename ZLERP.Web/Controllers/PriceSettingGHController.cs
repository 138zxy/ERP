...
{
    public class PriceSettingGHController : BaseController<PriceSettingGH, int>
    {
        ...
        public override ActionResult Add(PriceSettingGH PriceSetting)
        {
        ...
        public void UpdateContractItem(int id)
        {
            ...
            if (price != null)
            {
                var server = this.service.GetGenericService<ContractItemGH>();
                ContractItemGH ci = server.Get(id);
