...
namespace ZLERP.Web.Controllers
{
    public class CarController : BaseController<Car,string>
    {
        public override ActionResult Index()
        {
            ...
            ViewBag.RentCarNames = new SelectList(RentCarName, "ID", "FleetName");
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public ActionResult GetMixerCarStatus(int? companyId,int? dataType=0)
        {
            if (dataType == null)
                dataType = 0;
            dynamic car = this.service.Car.GetMixerCarStatus(companyId, dataType);
            return this.Json(car);
        }
        ...
        public ActionResult ShiftMixerCarStatusGH(string operType, string carId, string status)
        {
            this.service.Car.ShiftMixerCarStatusGH(operType, carId, status);
            return OperateResult(true, Lang.Msg_Operate_Success, null);
        }
        ...
        /// <param name="code"></param>
        /// <returns></returns>
        public ActionResult AllToRestCar(string carStatus,int? dataType=0)
        {
            try
            {
                this.service.Car.AllToRestCar(carStatus, dataType);
                return OperateResult(true, Lang.Msg_Operate_Success, null);
            }
            catch (Exception e)
            {
        ...
        /// <param name="code"></param>
        /// <returns></returns>
        public ActionResult AllToAllowShipCar(string carStatus, int? dataType = 0)
        {
            try
            {
                this.service.Car.AllToAllowShipCar(carStatus, dataType);
                return OperateResult(true, Lang.Msg_Operate_Success, null);
            }
            catch (Exception e)
            {
        ...
        public ActionResult GetMixerCarStatusGH(string id)
        {
            dynamic car = this.service.Car.GetMixerCarStatusGH(id);
            return this.Json(car);
        }

        
        public ActionResult RestCarByRentCarName(int? RentCarName, int? dataType = 0)
        {
            try
            {
                this.service.Car.RestCarByRentCarName(RentCarName, dataType);
                return OperateResult(true, Lang.Msg_Operate_Success, null);
            }
            catch (Exception e)
            {
        ...
        public ActionResult AllowShipCarByRentCarName(int? RentCarName, int? dataType = 0)
        {
            try
            {
                this.service.Car.AllowShipCarByRentCarName(RentCarName, dataType);
                return OperateResult(true, Lang.Msg_Operate_Success, null);
            }
            catch (Exception e)
            {
