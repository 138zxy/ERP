...
namespace ZLERP.Web.Controllers
{
    ...
    {
        public static object customerObj = new object();
        ...
        /// <returns></returns>
        [HttpPost, HandleAjaxError]
        public virtual ActionResult FindNew(JqGridRequest request, string condition)
        {
            int total;
            IList<TEntity> list = m_ServiceBase.Find(request, condition, out total);
        ...
        /// <returns></returns>
        public virtual ActionResult SendMsg(string msgtype, string msgcontent)
        {
            try
            {
                m_ServiceBase.SendMsg(msgtype, msgcontent);
                return OperateResult(true, Lang.Msg_Operate_Success, null);
            }
            catch (Exception ex)
            {
        ...
        public virtual ActionResult SendMsg(string msgtype, string msgcontent, string tzvalue, bool appshow)
        {
            try
            {
                m_ServiceBase.SendMsg(msgtype, msgcontent, appshow, tzvalue);
                return OperateResult(true, Lang.Msg_Operate_Success, null);
            }
            catch (Exception ex)
            {
        ...
        public virtual ActionResult SendMsg(string msgtype, string msgcontent, string tzvalue, bool appshow, string userid)
        {
            try
            {
                m_ServiceBase.SendMsg(msgtype, msgcontent, appshow, tzvalue, userid);
                return OperateResult(true, Lang.Msg_Operate_Success, null);
            }
            catch (Exception ex)
            {
