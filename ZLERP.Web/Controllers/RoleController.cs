...
namespace ZLERP.Web.Controllers
{
    public class RoleController : BaseController<Role, string>
    {
        ...
        /// <param name="roleId"></param>
        /// <returns></returns>
        public JsonResult GetRoleOrganizations(string roleId)
        {
            return Json(this.service.Role.GetRoleOrganizations(roleId));
        }
        ...
        /// <param name="powers"></param>
        /// <returns></returns>
        public ActionResult SaveRoleOrganizations(string[] roleIds, string[] powers)
        {
            //UNDONE:同时修改多用户权限的问题
            this.service.Role.SaveRoleOrganizations(roleIds, powers);
            return OperateResult(true, Lang.Msg_Operate_Success, "");
        }
