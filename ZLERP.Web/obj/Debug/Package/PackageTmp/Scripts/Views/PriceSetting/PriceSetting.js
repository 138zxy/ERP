...
function priceSettingIndexInit(options) {
    ...
    var contractPumpGrid = new MyGrid({
        ...
        , singleSelect: true
        , initArray: [
              { label: "合同泵送编号", name: "ID", index: "ID", width: 65, hidden: true }
            , { label: "合同编号", name: "ContractID", index: "ContractID", width: 100, hidden: true }
            , { label: "泵车类型", name: "PumpType", index: "PumpType", width: 80, align: "center" }
            , { label: "建立人", name: "Builder", index: "Builder" }
            , { label: "建立时间", name: "BuildTime", index: "BuildTime", formatter: "date", width: 80 }
            , { label: "修改人", name: "Modifier", index: "Modifier" }
            , { label: "修改时间", name: "ModifyTime", index: "ModifyTime", formatter: "date", width: 80 }
    ...
    //合同泵车价格列表
    var contractPumpPriceGrid = new MyGrid({
        renderTo: "ContractPumpPriceDiv"
        , title: "合同泵送价格"
        , autoWidth: true
        //         , buttons: buttons0
        //         , buttonRenderTo: "buttonToolbar"
        ...
        , dialogWidth: 700
        , dialogHeight: 20
        , storeURL: options.ContractPumpPriceStoreUrl
        , storeCondition: "1<>1"
        , sortByField: "ChangeTime"
        , sortOrder: 'DESC'
        , primaryKey: "ID"
        ...
        , singleSelect: true
        , initArray: [
              { label: "合同泵送价格编号", name: "ID", index: "ID", width: 65, hidden: true }
            , { label: "合同泵送编号", name: "ContractPumpID", index: "ContractPumpID", width: 100, hidden: true }
            , { label: "泵送价格", name: "PumpPrice", index: "PumpType", width: 80, align: "center" }
            , { label: "改价时间", name: "ChangeTime", index: "ChangeTime", formatter: "datetime", width: 80, align: "center" }
            , { label: "建立人", name: "Builder", index: "Builder" }
            , { label: "建立时间", name: "BuildTime", index: "BuildTime", formatter: "date", width: 80 }
            , { label: "修改人", name: "Modifier", index: "Modifier" }
        ...
        , functions: {
            handleReload: function (btn) {
                contractPumpPriceGrid.reloadGrid();
            },
            handleRefresh: function (btn) {
