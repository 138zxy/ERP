...
function consMixpropIndexInit(opts) {
    ...
    var options = {
            ...
            , datatype: 'json'
            , mtype: 'POST'
            , postData: { condition: " ProduceTask.IsCompleted=0 and AuditStatus = 1 and ProductLineID = '001'  AND DataType=1  " }
            , jsonReader: {
                root: "rows",
                page: "page",
                total: "total",
    ...
    var functions = {
        ...
        , handleViewAudited: function (btn) {
            ...
            var data = { url: opts.storeUrl, datatype: "json", page: 1, postData: { condition: plValue + "AuditStatus = 1 AND  DataType=1 "} };
    ...
    function CreateJqGrid(options) {
        ...
        jQuery("#ConsGridDiv").jqGrid('navButtonAdd', 'ConsGridDivPager', { caption: "查询", buttonicon: 'ui-icon ui-icon-search', onClickButton: function () {
            if (showSearchToolBar) {
                jQuery("#ConsGridDiv")[0].toggleToolbar();
            } else {
                $("#ConsGridDiv").jqGrid('filterToolbar', { stringResult: true });
                jQuery("#ConsGridDiv")[0].clearToolbar();
...
//       jQuery("#ConsGridDiv").jqGrid('navButtonAdd', '#ConsGridDivPager', { caption: "导出", buttonicon: 'ui-icon ui-icon-disk', onClickButton: function () {
//            jQuery("#ConsGridDiv").jqGrid('excelExport', { url: "excel" });
//        }
//        });
    ...
    function getDynamicColAndCreateGrid(pid, plValue) {
        ajaxRequest(
                ...
                function (response) {
                    ...
                    options.postData = { condition: plValue + "AuditStatus = 1  AND DataType=1 " };
