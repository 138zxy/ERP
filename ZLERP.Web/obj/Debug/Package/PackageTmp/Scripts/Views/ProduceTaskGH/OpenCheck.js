function TaskIndexInit(storeUrl) {
    var mygrid = new MyGrid({
        ...
        , { label: ' 干混配比ID', name: 'BetonFormula', index: 'BetonFormula', width: 80, hidden: true }
        , { label: ' 砂浆配比', name: 'SlurryFormulaName', index: 'SlurryFormulaInfo.FormulaName', width: 80, hidden: true }
        , { label: '砂浆配比ID', name: 'SlurryFormula', index: 'SlurryFormula', hidden: true }
        , { label: '强度', name: 'ConStrength', index: 'ConStrength', align: 'center', width: 70 }
                ...
                handlePrintExam: function (btn) {
                    ...
                    mygrid.showWindow({
                        ...
                        afterLoaded: function () {
                            ...
                            $.post(
                                "/ProduceTaskGH.mvc/FindFilesInfoByPath",
                                {
                                    path: path
                                },
                                function (resp) {
