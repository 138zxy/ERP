...
function dispatchListIndexInit(options) {
    ...
    var scrwGrid = new MyGrid({
        ...
        //, groupField: 'IsFormulaSend'
            ...
            , { label: '客户名称', name: 'Contract.Customer.CustName', index: 'Contract.Customer.CustName', width: 150, searchoptions: { sopt: ['cn']} }
...
//    });
    ...
    var scdjGrid = new MyGrid({
        ...
        //, autoWidth: true
            ...
            , storeCondition: "IsCompleted = 0 AND DataType=0"
    ...
    function refreshCarStatus() {
        ...
        ajaxRequest(options.getCarStatusUrl, { "IsUsed": "1",  "CompanyID": companyId }, false, function (response) {
    ...
    function setScdjForm(record) {
        ...
        taskidAll = taskid;
        var companyId = $("#CompanyID").val();
        ajaxRequest(options.getLastDocUrl, { id: taskid, companyId: companyId,dataType:0 }, false, function (response) {
    ...
    function carSelectAction(carid) {
        ...
        ajaxRequest(options.getCarInfoUrl, { id: carid }, false, function (response) {
            ...
            ajaxRequest(options.getRemaincubeUrl, { carId: carid, taskid: taskidAll,lineid:proline }, false, function (response) {
    ...
    if (gSysConfig.SCDJRefreshInterval) {
        ...
        if (refreshInterval > 0) {
            ...
            if (gSysConfig.IsRefreshCarStatus == "true") {
                if (gTimer_Car) clearInterval(gTimer_Car);
