function HR_GZ_DeductIndexInit(options) {
    ...
    var myJqGrid = new MyGrid({
		...
		, setGridPageSize: 30
		, showPageBar: true
        , groupField: 'HR_GZ_DeductSet.Name'
        , groupingView: {
		...
		, initArray: [
            ...
            , { label: '项目名称', name: 'HR_GZ_DeductSet.Name', index: 'HR_GZ_DeductSet.Name', width: 80 }
            , { label: '单价', name: 'UnitPrice', index: 'UnitPrice', width: 80, search: false }
            , { label: '数量', name: 'Quantity', index: 'Quantity', width: 80, search: false }
    ...
    $("#UnitPrice").change(function () {
        ...
        if (UnitPrice >= 0 && Quantity >= 0) {
            var all = UnitPrice * Quantity/100;
            $("#AllMoney").val(all); 
        }
    });
