    ...
    $.fn.daterangepicker = function (settings) {
        ...
        var options = $.extend({
            presetRanges: [
				...
				{ text: '最近7天', dateStart: 'today-7days', dateEnd: 'today' },
				{ text: '当月', dateStart: function () { return Date.parse('today').moveToFirstDayOfMonth(); }, dateEnd: function () { return Date.parse('today').moveToLastDayOfMonth(); } },
				{ text: '当年', dateStart: function () { var x = Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: function () { var x = Date.parse('today'); x.setMonth(11); x.setDate(31); return x; } },
            //extras:
				{text: '上个月', dateStart: function () { return Date.parse('1 month ago').moveToFirstDayOfMonth(); }, dateEnd: function () { return Date.parse('1 month ago').moveToLastDayOfMonth(); } }
