    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        refresh();
         if (!Page.IsPostBack)
         {
            ...
            this.DropDownList4.DataSource = this.SqlDataSource5;
            this.DropDownList4.DataTextField = "SiloName";
            this.DropDownList4.DataValueField = "SiloID";
            this.DropDownList4.DataBind();
            
            this.DropDownList4.Items.Insert(0, li);
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    筒仓：<asp:DropDownList ID="DropDownList4" runat="server" Width="150px" >
    </asp:DropDownList>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="DropDownList4" Name="SiloID" PropertyName="Text" />
    ...
    <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
           ConnectionString="<%$ ConnectionStrings:ZLERP %>" 
           ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" 
           SelectCommand="select SupplyID,SupplyName  from SupplyInfo  where IsUsed=1 and SupplyKind in('Su3','Su5') order by SupplyName "  SelectCommandType="Text" CancelSelectOnNullParameter="False"  >
    </asp:SqlDataSource>
</asp:Content>
