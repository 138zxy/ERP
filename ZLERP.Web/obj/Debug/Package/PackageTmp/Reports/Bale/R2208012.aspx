...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    是否包含手动：
            <asp:DropDownList ID="CheckSD" runat="server" Width="150px">
                <asp:ListItem Text="包含" Value="1"></asp:ListItem>
                <asp:ListItem Text="不包含" Value="0"></asp:ListItem>
              </asp:DropDownList>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Bale\R2208012.rdlc" DisplayName="材料消耗表">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_rpt_StuffandBaleT"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="CheckSD" Name="isHand" PropertyName="Text" />            
        </SelectParameters>
    </asp:SqlDataSource>
