<%@ Page Title="原材料台账报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        refresh();
         if (!Page.IsPostBack)
         {
            ...
            this.DropDownList1.DataTextField = "SiloName";
            this.DropDownList1.DataValueField = "SiloID";
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        rpt.SetParameters(new ReportParameter("SiloID", this.DropDownList1.SelectedValue));
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    筒仓名称：<asp:DropDownList ID="DropDownList1" runat="server" Width="150px" ></asp:DropDownList>
    <div style="display:none;">材料名称：<asp:DropDownList ID="DropDownList2" runat="server" Width="150px" ></asp:DropDownList></div>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Bale\R220824.rdlc" DisplayName="原材料台账报表">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_rpt_StuffLedger"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="DropDownList1" Name="SiloID" PropertyName="Text" />          
