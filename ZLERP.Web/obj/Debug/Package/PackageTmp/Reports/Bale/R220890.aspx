<%@ Page Title="日成消耗汇总（按材料）" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<%--    材料名称：<asp:DropDownList ID="DropDownList2" runat="server" Width="150px" >--%>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="700px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Bale\R220890.rdlc" DisplayName="日成消耗汇总（按材料）">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_rpt_stuffUsed"
