...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
 ...
 供应商名称：<asp:TextBox ID="tb_Supply"  runat="server"></asp:TextBox>  
 ...
 <asp:Button ID="btnQuery" runat="server" OnClick="btnQuery_Click" Text="查询" />
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Finance\R020105.rdlc"  DisplayName="混凝土运费结算单">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_Material"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
          <SelectParameters>
