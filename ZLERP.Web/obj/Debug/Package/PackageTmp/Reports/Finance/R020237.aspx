<%@ Page Title="原材料运费明细表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        refresh();
         if (!Page.IsPostBack)
         {
            ...
            this.DropDownList5.DataTextField = "SupplyName";
            this.DropDownList5.DataValueField = "SupplyID";
            this.DropDownList5.DataBind();
            this.DropDownList5.Items.Insert(0, li);
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        rpt.SetParameters(new ReportParameter("TransportID", this.DropDownList5.SelectedValue));
        this.ReportViewer1.LocalReport.Refresh();
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    供货商：<asp:TextBox ID="TBSupplyID" runat="server"></asp:TextBox>
    运输商: <asp:DropDownList ID="DropDownList5" runat="server" Width="150px" >
    </asp:DropDownList>
    车牌：<asp:TextBox ID="tbCarNo" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Finance\R020237.rdlc" DisplayName="原材料运费明细表">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_rpt_BalanceStuffIn"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="DropDownList5" Name="TransportID" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
           ConnectionString="<%$ ConnectionStrings:ZLERP %>" 
           ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" 
           SelectCommand="select SupplyID,SupplyName  from SupplyInfo  where IsUsed=1 and SupplyKind in('Su1','Su5','Su2') order by SupplyName "  SelectCommandType="Text" CancelSelectOnNullParameter="False"  >
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
           ConnectionString="<%$ ConnectionStrings:ZLERP %>" 
           ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" 
           SelectCommand="select SiloID,SiloName from Silo where ISUSED=1 "  SelectCommandType="Text" CancelSelectOnNullParameter="False"  >
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
           ConnectionString="<%$ ConnectionStrings:ZLERP %>" 
           ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" 
           SelectCommand="select SupplyID,SupplyName  from SupplyInfo  where IsUsed=1 and SupplyKind in('Su7') order by SupplyName "  SelectCommandType="Text" CancelSelectOnNullParameter="False"  >
    </asp:SqlDataSource>
</asp:Content>
