<%@ Page Title="原材料供应商应付报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    供货商：<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
    <asp:Button ID="btnQuery" runat="server" OnClick="btnQuery_Click" Text="查询" />
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="600px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Finance\R020236.rdlc" DisplayName="原材料供应商应付报表">
            <DataSources>
...
<%--    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="600px" runat="server" Font-Names="Verdana" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_SupplyAccountYF"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="TextBox1" Name="SupplyName" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
