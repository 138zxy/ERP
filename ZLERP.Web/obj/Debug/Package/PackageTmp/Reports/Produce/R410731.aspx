...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <asp:RequiredFieldValidator runat="server" CssClass="red" ControlToValidate="tbBeginDate" Display="Dynamic" ErrorMessage="*">
            ...
            <!--新加了两个查询条件-->
    工程名称：<asp:TextBox ID="tbProjectName" Width="150" runat="server"></asp:TextBox>
    砼强度：<asp:TextBox ID="tbConStrength" Width="100" runat="server"></asp:TextBox>
    任务单号：<asp:TextBox ID="tbTaskID" Width="100" runat="server"></asp:TextBox>
    客户名称：<asp:TextBox ID="tbCustName" Width="150" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server"   
           ...
           <SelectParameters>  
               ...
               <asp:ControlParameter ControlID="tbTaskID" Name="TaskID" PropertyName="Text" />    
