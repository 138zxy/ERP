...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (tbBeginDate.Text == "")
            {
                this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("BeginDate", " "));
            }
            else
            {
            ...
            if (tbEndDate.Text == "")
            {
                this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("EndDate", " "));
            }
            else
            {
            ...
            {
                this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("khmc", " ")); 
            }
            else
            {
                this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("khmc", tbProjectName.Text));
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Produce\R4107888.rdlc" DisplayName="生产方量统计报表">
            <DataSources>
