...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            this.tbStartDateTime.Text = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1, 0, 0 , 0).ToShortDateString();
            this.tbEndDateTime.Text = DateTime.Now.ToShortDateString();
        }
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    起始日期:<asp:TextBox ID="tbStartDateTime" Width="135" runat="server"></asp:TextBox>
    ...
    客户名称:<asp:TextBox ID="txtCustName" runat="server" Width="135"></asp:TextBox>
    合同名称:<asp:TextBox ID="txtContractName" runat="server" Width="135"></asp:TextBox>
