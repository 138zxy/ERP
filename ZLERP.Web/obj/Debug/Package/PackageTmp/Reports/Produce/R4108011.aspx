...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    起始时间：<asp:TextBox ID="tbBeginDate" runat="server" Width="120px"></asp:TextBox>
    截止时间：<asp:TextBox ID="tbEndDate" runat="server"  Width="120px"> </asp:TextBox>
    生产线：<asp:DropDownList ID="tbProductLineID" runat="server" Width="100px">
    </asp:DropDownList>
    <div style="display:none">工程名称：<asp:TextBox ID="tbProjectName" runat="server" Width="150px"></asp:TextBox></div>
    ...
    车号：<asp:TextBox ID="tbCarID" Width="100" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\Produce\R4108011.rdlc" DisplayName="生产记录日报表">
            <DataSources>
