<%@ Page Title="客户出货统计表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            System.Data.DataSet ds = helper.ExecuteDataset("select CustomerID,CustName from Customer order by CustName", System.Data.CommandType.Text, null);
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    客户：<asp:DropDownList ID="ddlCustomerID" runat="server" DataTextField="CustName" 
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Sales\R310401.rdlc"  DisplayName="客户出货统计表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server"   
           ...
           SelectCommand="sp_rpt_customer_produce_summary"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters>  
                ...
                <asp:ControlParameter ControlID="ddlCustomerID" Name="CustomerID" 
