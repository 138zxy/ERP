<%@ Page Title="干混销售统计报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<script runat="server" language="c#">
    ...
    void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        if (this.tbContractNo.Text == "") 
        { 
            this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("ContractNo", " ")); 
        }
        else
        {
            this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("ContractNo", this.tbContractNo.Text));
        }
        if (this.tbProjectName.Text == "")
        {
            this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("ProjectName", " "));
        }
        else
        {
            this.ReportViewer1.LocalReport.SetParameters(new ReportParameter("ProjectName", this.tbProjectName.Text));
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    合同号：<asp:TextBox ID="tbContractNo" runat="server"></asp:TextBox>　
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Sales\R310426.rdlc"  DisplayName="干混销售统计报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server"   
           ...
           SelectCommand="sp_rpt_ConStrengthSale_GH"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters>  
             ...
             　<asp:ControlParameter ControlID="tbContractNo" Name="ContractNo" PropertyName="Text" />  
