<%@ Page Title="销售台账报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    业务员名称：<asp:TextBox ID="tbSaleName" runat="server"></asp:TextBox>
    合同名称：<asp:TextBox ID="tbContractName" runat="server"></asp:TextBox>
    浇筑方式：<asp:TextBox ID="tbCastMode" runat="server"></asp:TextBox>
    浇筑部位：<asp:TextBox ID="tbConsPos" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Sales\R310429.rdlc"  DisplayName="销售台账报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server"   
           ...
           SelectCommand="sp_rpt_Sales_Detail"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters>  
                ...
                <asp:ControlParameter ControlID="tbSaleName" Name="SaleName" PropertyName="Text" />
