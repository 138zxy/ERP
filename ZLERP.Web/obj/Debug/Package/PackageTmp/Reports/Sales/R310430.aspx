<%@ Page Title="工地计划报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" 
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {            
            ...
            tbBeginDate.Text = DateTime.Today.ToString("yyyy-MM-dd") + " 19:00";
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    审核起始时间：<asp:TextBox ID="tbBeginDate" Width="135" runat="server"></asp:TextBox>
    ...
    审核截止时间：<asp:TextBox ID="tbEndDate" runat="server" Width="135"></asp:TextBox>
    <asp:RequiredFieldValidator
        ID="RequiredFieldValidator2" runat="server" CssClass="red" ControlToValidate="tbEndDate"
        Display="Dynamic" ErrorMessage="*">
    </asp:RequiredFieldValidator>
    客户名称：<asp:TextBox ID="tbCustName" Width="100" runat="server"></asp:TextBox>
    工程名称：<asp:TextBox ID="tbProjectName" Width="100" runat="server"></asp:TextBox>
    施工部位：<asp:TextBox ID="tbConsPos" Width="100" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Sales\R310430.rdlc"  DisplayName="工地计划报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_customPlan"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="tbConsPos" Name="consPos" PropertyName="Text" />
