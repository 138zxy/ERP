<%@ Page Title="强度检测" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        <LocalReport ReportPath="Reports\FuHuang\qdjc.rdlc"  DisplayName="强度检测">  
            <DataSources>
       ...
       <<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_fh_kpjd"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
