...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        <LocalReport ReportPath="Reports\Lab\R720801.rdlc"  DisplayName="混凝土抗压强度检测报告">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_Lab_ConWPRecord"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
