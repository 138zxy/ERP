    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.Cookies["rFrameHeight"] != null)
            {
                ...
                this.ReportViewer1.Height = int.Parse(strHeight) - 20;
            }
            else
            {
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <LocalReport ReportPath="Reports\ProduceGH\R950711.rdlc"  DisplayName="剩退料统计报表">  
        <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"   
        ...
        SelectCommand="sp_rpt_tzrelation_stats_GH"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="false"  >
        <SelectParameters>  
