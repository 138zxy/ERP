<%@ Page Title="泵车油耗统计分析表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.DropDownList1.DataTextField = "CarNo";
            this.DropDownList1.DataValueField = "CarID";
            this.DropDownList1.DataBind();
            this.DropDownList1.Items.Insert(0, String.Empty);
        }
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    泵车：<asp:DropDownList ID="DropDownList1" runat="server">
        </asp:DropDownList>
 <asp:Button ID="btnQuery" runat="server" OnClick="btnQuery_Click" Text="查询" />
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Pump\R940303.rdlc"  DisplayName="泵车油耗统计分析表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_PumpOilAnalyse"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
          <SelectParameters>
            ...
            <asp:ControlParameter ControlID="DropDownList1" Name="CarID" PropertyName="Text" /> 
          </SelectParameters>
       </asp:SqlDataSource>
       <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
           ConnectionString="<%$ ConnectionStrings:ZLERP %>" 
           ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" 
           SelectCommand="select * from Car where CarTypeID='CT2' and IsUsed=1"  SelectCommandType="Text" CancelSelectOnNullParameter="False"  >
       </asp:SqlDataSource>
</asp:Content>
