...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        合同编号:<asp:TextBox ID="tbContractID" runat="server"></asp:TextBox>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="900px" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          　        <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="tbEndDate" Name="EndDate"   PropertyName="Text" />
                     <asp:ControlParameter ControlID="tbContractID" Name="ContractID" PropertyName="Text" />
