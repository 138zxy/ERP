<%@ Page Title="车辆租赁结算单" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.tbYlbs.DataSource = this.SqlDataSource4;
            this.tbYlbs.DataTextField = "bs";
            this.tbYlbs.DataValueField = "bs";
            this.tbYlbs.DataBind();
        }
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <div style="display:none;">余料单价倍数：<asp:DropDownList ID="tbYlbs" runat="server" Width="100px"></asp:DropDownList> </div>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Car\R610220.rdlc"  DisplayName="车辆租赁结算单">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_CarProjectHz"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters>
            ...
            <asp:ControlParameter ControlID="tbYlbs" Name="Ylbs" PropertyName="Text" />
        </SelectParameters>
       </asp:SqlDataSource> 
    ...
    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="SELECT 1 as bs
UNION ALL
SELECT 1.5
UNION ALL
SELECT 2 "
