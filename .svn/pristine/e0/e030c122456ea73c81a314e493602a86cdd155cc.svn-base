...
function contractIndexInit(options) {
    var ContractGrid = new MyGrid({
        ...
        storeCondition: "ContractStatus != '3' AND DataType=1 ",
        sortByField: "ID",
        primaryKey: "ID",
        setGridPageSize: 30,
        showPageBar: true,
        ...
        functions: {
            ...
            handleRefresh: function (btn) {
                ContractGrid.refreshGrid("ContractStatus != '3'  AND DataType=1 ");
            },
            ...
            handleUnAuditContract: function (btn) {
                ...
                if (auditValue == 0) {
					...
					function () {
						...
						true,
						function () {
						    ContractGrid.refreshGrid(" DataType=1 ");
						});
					    $(this).dialog("close");
					});
                }
            ...
            handleNotCompleted: function () {
                ContractGrid.refreshGrid("ContractStatus != 3 and IsLimited = 0  AND DataType=1 ");
            },
            //受限合同
            handleLimitBy: function () {
                ContractGrid.refreshGrid("IsLimited = 1  AND DataType=1 ");
            },
            ...
            handleEditContractStatus: function (btn) {
                ...
                ContractGrid.handleEdit({
                    ...
                    postCallBack: function (response) {
                        ContractGrid.refreshGrid("1=1  AND DataType=1 "); //回调刷新
                    }
                });
            },
