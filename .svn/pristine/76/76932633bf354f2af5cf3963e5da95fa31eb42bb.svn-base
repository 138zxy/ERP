...
namespace ZLERP.Business
{
    public class SystemMsgService : ServiceBase<SystemMsg>
    {
        ...
        /// <returns></returns>
        public override bool SendMsg(string MsgID, string ObjID)
        {
        ...
        /// <param name="AppShow"></param>
        /// <param name="tzvalue"></param>
        /// <param name="userId"></param>
        /// <param name="sender"></param>
        /// <param name="sendtime"></param>
        /// <returns></returns>
        public bool SendMsg(string MsgID, string ObjID, bool AppShow, string tzvalue, string userId, string sender, DateTime? sendtime)
        {
            using (IGenericTransaction tx = this.m_UnitOfWork.BeginTransaction())
            {
                try
                {
                    ...
                    string url = string.Empty;
                    string pid = string.Empty;
                    if (msg.BelongFuncID == null)
                    {
                        //throw new Exception("消息没有分配任何接收用户！");
                        return false;
                    }
                    this.getUrlAndPid(msg.BelongFuncID, out url, out pid);
                    if (msg == null)
