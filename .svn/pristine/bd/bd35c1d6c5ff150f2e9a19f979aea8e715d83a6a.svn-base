...
namespace ZLERP.Model.Generated
{
    ...
    public abstract class _StuffIn : EntityBase<string>
    {
        ...
        /// </summary>
        [DisplayName("总重")]
        [Range(0, 999999999, ErrorMessage = "入库数量必须是0 到 9999 吨之间")]
        ...
        /// </summary>
        [DisplayName("空车重")]
        [Range(0, 999999999, ErrorMessage = "入库数量必须是0 到 999 吨之间")]
        ...
        //[Required]
        [DisplayName("原料单价")]
        [Range(0.000000,float.MaxValue,ErrorMessage="单价必须是大于等于0的数")]
        ...
        /// </summary>
        [DisplayName("扣重")]
        public virtual decimal? MingWeight
        {
            get;
			set;			 
        }	
