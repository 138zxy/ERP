<%@ Page Title="车辆保养统计表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    车号：<asp:TextBox ID="tbCarID" runat="server"></asp:TextBox>
    起始时间：<asp:TextBox ID="tbBeginDate" runat="server"></asp:TextBox>
    截止时间：<asp:TextBox ID="tbEndDate" runat="server"></asp:TextBox>
    保养单位：<asp:TextBox ID="tbKeepUnit" runat="server"></asp:TextBox>
    保养项目：<asp:TextBox ID="tbKeepItem" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Car\R610223.rdlc"  DisplayName="车辆保养统计表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_CarKeep"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters>
            ...
            <asp:ControlParameter ControlID="tbKeepUnit" Name="KeepUnit" PropertyName="Text" />
            <asp:ControlParameter ControlID="tbKeepItem" Name="KeepItem" PropertyName="Text" />
        </SelectParameters>
       </asp:SqlDataSource>
</asp:Content>
