...
namespace ZLERP.Model.ViewModels
{
    ...
    public class SchedulerViewModelGH
    {
        public DispatchListGH DispatchListGH { get; set; }

        public ShippingDocumentGH ShippingDocumentGH { get; set; }

        public TZRalationGH TZRalationGH { get; set; }

        public CustomerPlanGH CustomerPlanGH { get; set; }

        public InsteadProduct InsteadProduct { get; set; }

        public ProduceTaskGH ProduceTaskGH { get; set; }
    }
}
