...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Bale\R2208051.rdlc"  DisplayName="筒仓用量统计报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_siloAmountT"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
          　<SelectParameters>
            ...
            <asp:ControlParameter ControlID="tbProductLineID" Name="ProductLine" PropertyName="Text" />
          </SelectParameters>
       </asp:SqlDataSource> 
