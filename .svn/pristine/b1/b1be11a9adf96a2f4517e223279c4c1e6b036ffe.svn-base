...
{
    public class ConsMixpropItemGHRepository : NHRepositoryBase<ConsMixpropItemGH>, IConsMixpropItemGHRepository
    {
        public ConsMixpropItemGHRepository(ISession session)
            : base(session)
        {
        ...
        public bool ChangeSilo(string S_SiloID, string D_SiloID, string[] ids)
        {
            ...
            {
                string sp = "exec sp_ChangeSiloGH @s_siloid=:s_siloid,@d_siloid=:d_siloid,@cid=:cid";
