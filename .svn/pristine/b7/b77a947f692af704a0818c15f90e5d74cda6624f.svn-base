...
{
    public class ProjectGHService : ServiceBase<ProjectGH>
    {
        internal ProjectGHService(IUnitOfWork uow) : base(uow) { }

        public override ProjectGH Add(ProjectGH entity)
        {
            try
            {
                ProjectGH temp = base.Add(entity);
