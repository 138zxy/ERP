...
function contractIndexInit(options) {
    ...
    var ContractGrid = new MyGrid({
        renderTo: "Contractid"
            ...
            , height: 300 //gGridWithTitleHeight
            , dialogWidth: 760
            , dialogHeight: 440
           ...
           //, singleSelect: true
            , initArray: [
                ...
                , { label: "是否技术交底", name: "IsJSJD", index: "IsJSJD", align: "center", width: 60, formatter: booleanFmt, unformat: booleanUnFmt, stype: "select", searchoptions: { value: booleanSearchValues()} }
