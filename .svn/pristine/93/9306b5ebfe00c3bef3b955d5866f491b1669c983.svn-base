...
//                , { label: '机组', name: 'ProductLineName', index: 'ProductLineName', width: 50 }
                ...
                , { label: '所属线号', name: 'line', index: 'OrderNum', search: false, align: 'center', width: 70, editable: true, editrules: { required: true, number: true } }
                , { label: '下料口号', name: 'store', index: 'store', search: false, align: 'center', width: 70}
   		        , { label: 'NC仓库', name: 'Bd_Stordoc', index: 'Bd_Stordoc', stype: 'select', searchoptions: { value: dicToolbarSearchValues('Bd_Stordoc') }, formatter: dicCodeFmt, unformat: dicCodeUnFmt, formatoptions: { parentId: 'Bd_Stordoc' }, width: 80, align: 'center', hidden: true }
		    ]
            , functions: {
