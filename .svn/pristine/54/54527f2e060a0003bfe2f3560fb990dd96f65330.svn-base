function HR_KQ_LeaveIndexInit(options) {
    var myJqGrid = new MyGrid({
		...
		, initArray: [
            ...
            , { label: '请假单号', name: 'LeaveNo', index: 'LeaveNo', width: 120 }   
            ...
            , { label: '请假类型', name: 'LeaveType', index: 'LeaveType', width: 80 }
            ...
            , { label: '请假/天', name: 'DayLong', index: 'DayLong', width: 80 } 
            , { label: '请假原因', name: 'Reson', index: 'Reson', width: 200 } 
        ...
        , functions: {
            ...
            handleAdd: function (btn) {
                ajaxRequest(options.GenerateOrderNoUrl, {prefix:"Q"},
				false,
				function (response) {
				    if (response.Result) { 
				        myJqGrid.handleAdd({
        ...
        handleEdit: function (btn) {
            ...
            ToAuditing: function (btn) {
                ...
                showConfirm("确认信息", "您确定要审核当前请假单:" + orderNo + "？",
				function () {
            ...
            ToUnAuditing: function (btn) {
                ...
                showConfirm("确认信息", "您确定要反审当前请假单:" + orderNo + "？",
				function () {
				    var requestURL = options.ChangeConditionUrl;
				    ajaxRequest(requestURL, {
				        type: 2,
