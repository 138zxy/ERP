...
function produceTaskIndexInit(opts) {
    ...
    var mygrid = new MyGrid({
        ...
        //, width: '100%'
            ...
            , sortByField: 'case when OpenTime is null then 1 else 0 end, OpenTime  '
            , sortOrder: 'ASC'
            , primaryKey: 'ID'
        //, groupField: 'TaskType'
        ...
        , { label: '施工部位', name: 'ConsPos', index: 'ConsPos', width: 120, searchoptions: { sopt: ['cn']} }
        ...
        , { label: '工地电话', name: 'Tel', index: 'Tel', width: 70 }
        ...
        , { label: '子分部工程', name: 'ChildProject', index: 'ChildProject' }
            ...
            , functions: {
                ...
                handleRefresh: function (btn) {
                    mygrid.refreshGrid('1=1 AND DataType=0');
                },
                            ...
                            afterFormLoaded: function () {
                                ...
                                bindSelectData(contractIdField,
                                        ...
                                        { textField: 'ContractName',
                                            valueField: 'ID',
                                            condition: "CustomerID='" + customerId + "' and ContractStatus!='3' and AuditStatus='1' AND DataType=0 AND IsLimited = 0 "
                                        }, function () {
                ...
                handleCompleted: function () {
                    mygrid.refreshGrid("IsCompleted = 1 AND DataType=0");
                },
                //未完工任务单 add by xyl on 2012-3-26
                handleNotCompleted: function () {
                    mygrid.refreshGrid("IsCompleted = 0 AND DataType=0");
                },
                ...
                handleThree: function (btn) {
                    ...
                    condition = "NeedDate between '" + uom + " 00:00:00' and '" + today + " 23:59:59' AND DataType=0";
                ...
                handleToday: function (btn) {
                    ...
                    //从0点算
                    condition = "NeedDate between '" + today + " 00:00:00' and '" + today + " 23:59:59' AND DataType=0";
                    //从交班时间开始算                    
                    ...
                    mygrid.showWindow({
                        ...
                        buttons: {
                            "关闭": function () {
                                ...
                                condition = "NeedDate between '" + BeginTime + "' and '" + EndTime + "' AND DataType=0";
                                mygrid.refreshGrid(condition);
        ...
        customerIdField.bind('change', function () {
            ...
            if (customerId) {
                bindSelectData(mygrid.getFormField("ContractID"),
                                        ...
                                        { textField: 'ContractName',
                                            valueField: 'ID',
                                            condition: "CustomerID='" + customerId + "' and ContractStatus!='3' and AuditStatus='1'  AND DataType=0 "
                                        }
                                    );
