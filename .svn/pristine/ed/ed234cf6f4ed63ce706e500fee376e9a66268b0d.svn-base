...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            lblCondition.Text = "IsProduce = 1 AND ShipDocType = '0' AND ProductLineName IS NOT NULL ";
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    施工部位：<asp:TextBox ID="tbConsPos" Width="120" runat="server"></asp:TextBox>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server"
        ...
        <LocalReport ReportPath="Reports\ProduceGH\R950704.rdlc" DisplayName="生产线方量统计报表">
            <DataSources>
