<%@ Page Title="开盘鉴定" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
        ...
        <LocalReport ReportPath="Reports\FuHuang\kpjd.rdlc"  DisplayName="开盘鉴定">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_fh_kpjd1"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters> 
