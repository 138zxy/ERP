<%@ Page Title="搅拌站泵送方量统计" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <div>
        ...
        泵车类型：<asp:DropDownList ID='ddlPumpType' runat="server">
            <asp:ListItem>所有泵车</asp:ListItem>
            <asp:ListItem>站内泵车</asp:ListItem>
            <asp:ListItem>站外泵车</asp:ListItem>
        </asp:DropDownList>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="100%" runat="server"
        ...
        <LocalReport ReportPath="Reports\Produce\R410809.rdlc" DisplayName="泵送方量统计">
            <DataSources>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_rpt_Pump"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ddlPumpType" Name="PumpType" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>

    <asp:SqlDataSource ID="subDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ZLERP %>"
        ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" SelectCommand="sp_rpt_PumpDetail"
        SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False">
        <SelectParameters>
            <asp:ControlParameter ControlID="tbBeginDate" Name="BeginDate" PropertyName="Text" />
            <asp:ControlParameter ControlID="tbEndDate" Name="EndDate" PropertyName="Text" />
