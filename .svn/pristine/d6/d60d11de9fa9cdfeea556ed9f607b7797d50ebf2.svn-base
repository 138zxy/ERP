...
namespace ZLERP.Model
{
    ...
    ///  运输单退转料关系表
    /// </summary>
    public class TZRalationHistoryGH : _TZRalationHistoryGH
    {
        [ScriptIgnore]
        public virtual ShippingDocumentGH SourceShippingDocument
        {
            get;
            set;
        }
        [ScriptIgnore]
        public virtual ShippingDocumentGH TargetShippingDocument
        {
            get;
            set;
        }
        ...
        /// 真实源车
        /// </summary>
        public virtual string operationnum
        {
            get;
            set;
        }
        ...
        /// 源车给予方量
        /// </summary>
        public virtual decimal? operationcube
        {
            get;
            set;
        }
