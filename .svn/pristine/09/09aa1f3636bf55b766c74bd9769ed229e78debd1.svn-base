<%@ Page Title="手动生产统计报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<script runat="server" language="c#">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            this.tbStuffName.DataSource = this.SqlDataSource3;
            this.tbStuffName.DataTextField = "SiloName";
            this.tbStuffName.DataValueField = "SiloName";
            this.tbStuffName.DataBind();
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    起始日期:<asp:TextBox ID="tbBeginDate" Width="135"  runat="server"></asp:TextBox> <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="red" ControlToValidate="tbBeginDate" Display="Dynamic" ErrorMessage="*">
            </asp:RequiredFieldValidator>
             
    截止日期:<asp:TextBox ID="tbEndDate" runat="server" Width="135" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="red" ControlToValidate="tbEndDate" Display="Dynamic" ErrorMessage="*">
            </asp:RequiredFieldValidator> 
    生产线:  <asp:DropDownList ID="tbProductLineID" runat="server" Width="150px" AutoPostBack="true"  >
            </asp:DropDownList>
    材料名称: <asp:DropDownList ID="tbStuffName" runat="server" Width="150px" AutoPostBack="true"  >
        </asp:DropDownList>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="500px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\Produce\R410707.rdlc"  DisplayName="手动生产统计报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="sp_rpt_produce_handleRecord"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
          　<SelectParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
           ConnectionString="<%$ ConnectionStrings:ZLERP %>" 
           ProviderName="<%$ ConnectionStrings:ZLERP.ProviderName %>" 
           SelectCommand="select ''  SiloName  union select  SiloName from Silo"  SelectCommandType="Text" CancelSelectOnNullParameter="False"  >
       </asp:SqlDataSource>
</asp:Content>
