...
{
    public class HR_GZ_DeductAnalysisController : BaseController<HR_GZ_Deduct, string>
    {
        //
        // GET: /SC_Base/
        ...
        public override ActionResult Find(JqGridRequest request, string condition)
        {
            ...
            var GZ_Piece = this.service.GetGenericService<HR_GZ_Deduct>().Query().Where(t => t.WorkDate >= begindate && t.WorkDate <= enddate)
            ...
            var GZ_PieceSet = this.service.GetGenericService<HR_GZ_DeductSet>().All();
