<%@ Page Title="运输单报表" Language="C#" MasterPageFile="~/Reports/ReportsBase.Master" Inherits="ZLERP.Web.Reports.ReportBase"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server"> 
    ...
    状态：<asp:CheckBox ID="tbIsEffective" Text="是否有效" TextAlign="Right" runat="server" Checked="true" />
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="600px" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="Reports\ProduceGH\R950706.rdlc"  DisplayName="运输单报表">  
            <DataSources>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server"   
           ...
           SelectCommand="sp_rpt_ShippDocGH"  SelectCommandType="StoredProcedure" CancelSelectOnNullParameter="False"  >
           <SelectParameters>  
                ...
                <asp:ControlParameter ControlID="tbIsEffective" Name="IsEffective" PropertyName="Checked" />  
             　
           </SelectParameters>
       </asp:SqlDataSource> 
