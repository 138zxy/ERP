...
{
    public class HR_KQ_OverController : HRBaseController<HR_KQ_Over, string>
    {
        public override ActionResult Index()
        {

            ViewBag.Leave = GetBaseData(BaseDataType.加班类型);
            return base.Index();
        }

        //public override ActionResult GenerateOrderNo()
        //{
        //    return base.GenerateOrderNo("J");
        //}

  

        public override ActionResult Add(HR_KQ_Over entity)
        {
