...
namespace ZLERP.Business.ControlSystem
{
    public class ControlSystemHelper
    {
        ...
        public bool GenConsmixpropGH(ConsMixpropGH cm, IList<ConsMixpropItemGH> cmItemsList)
        {
            if (cs != null)
            {
                return cs.GenConsMixpropGH(cm, cmItemsList);
            }
            return true;
        }
        /// <summary>
        ...
        /// <param name="cmItemsList"></param>
        /// <returns></returns>
        public ResultInfo UpdateConsMixpropGH(ConsMixpropGH cm, IList<ConsMixpropItemGH> cmItemsList)
        {
            if (cs != null)
            {
                return cs.UpdateConsMixpropGH(cm, cmItemsList);
            }
            return _TrueResult;
        }
    }
