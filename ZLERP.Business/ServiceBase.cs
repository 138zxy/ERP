...
namespace ZLERP.Business
{
    ...
    public class ServiceBase<TEntity> : IDisposable where TEntity : Entity
    {
        ...
        /// <param name="funcs"></param>
        /// <returns></returns>
        public IList<SysFuncAPP> VerifyFuncs(IList<SysFuncAPP> funcs)
        {
        ...
        /// <param name="funcs"></param>
        /// <returns></returns>
        public IList<Project> VerifyProjects(IList<Project> funcs)
        {
        ...
        /// <param name="funcs"></param>
        /// <returns></returns>
        public IList<Organization> VerifyOrganizations(IList<Organization> funcs)
        {
        ...
        /// <returns></returns>
        public virtual bool SendMsg(string msgtype, string msgcontent)
        {
            SystemMsgService systemMsgService = new SystemMsgService(this.m_UnitOfWork);
            bool issuccess = systemMsgService.SendMsg(msgtype, msgcontent);
            return issuccess;
        }
        /// <summary>
        /// 发消息
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public virtual bool SendMsg(string msgtype, string msgcontent, bool appshow, string tzvalue)
        {
            SystemMsgService systemMsgService = new SystemMsgService(this.m_UnitOfWork);
            bool issuccess = systemMsgService.SendMsg(msgtype, msgcontent, appshow, tzvalue);
            return issuccess;
        }
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public virtual bool SendMsg(string msgtype, string msgcontent, bool appshow, string tzvalue, string userid)
        {
            SystemMsgService systemMsgService = new SystemMsgService(this.m_UnitOfWork);
            bool issuccess = systemMsgService.SendMsg(msgtype, msgcontent, appshow, tzvalue, userid, "系统消息", DateTime.Now);
            return issuccess;
        }
    }
}
