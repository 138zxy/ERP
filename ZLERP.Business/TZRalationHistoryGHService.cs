...
{
    public class TZRalationHistoryGHService : ServiceBase<TZRalationHistoryGH>
    {
        internal TZRalationHistoryGHService(IUnitOfWork uow)
            : base(uow) { }
        ...
        /// <returns></returns>
        public override TZRalationHistoryGH Add(TZRalationHistoryGH entity)
        {
        ...
        public void AddHistory(TZRalationGH entity, string operation, string opertionnum, decimal? operationcube, string state)
        {
            //插入历史数据
