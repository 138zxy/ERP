...
{
    public class ConsMixpropGHRepository : NHRepositoryBase<ConsMixpropGH>, IConsMixpropGHRepository
    {
        public ConsMixpropGHRepository(ISession session)
        :base(session)
        { 
        ...
        {
            string sp = "exec sp_dispatch_check_measurescaleGH @TaskID=:TaskID, @ProductLineID=:ProductLineID, @ConcreteRZ=:ConcreteRZ, @SlurryRZ=:SlurryRZ, @CheckConcrete=:CheckConcrete, @CheckSlurry=:CheckSlurry";
